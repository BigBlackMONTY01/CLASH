...
const TOPICS = [
  ...
  { text: "Prisoners should have the right to vote", cat: "Ethics" },
  ...
  { text: "Stealing to feed your family is morally acceptable", cat: "Ethics" },
  { text: "Eating meat is morally equivalent to harming animals", cat: "Ethics" },
  { text: "Everyone has a moral duty to vote", cat: "Ethics" },
  ...
  { text: "Hollywood has run out of original ideas", cat: "Pop Culture" },
  { text: "Sports stars are paid too much", cat: "Pop Culture" },
  ...
  { text: "K-pop is the most dominant music movement of our era", cat: "Pop Culture" },
  ...
  { text: "Graffiti is art not vandalism", cat: "Society" },
  { text: "Cities should be designed for pedestrians not cars", cat: "Society" },
  { text: "Public transport should always be free", cat: "Society" },
  { text: "Unpaid internships should be illegal", cat: "Society" },
  ...
  { text: "Gentrification destroys more than it creates", cat: "Society" },
  ...
  { text: "Political polarization is the biggest threat to democracy", cat: "Society" },
  { text: "Social media is more addictive than cigarettes", cat: "Society" },
  { text: "AI will replace most white-collar jobs within 20 years", cat: "Technology" },
  { text: "The smartphone is the most transformative invention of the century", cat: "Technology" },
  ...
  { text: "Electric vehicles will not solve the climate crisis", cat: "Technology" },
  { text: "AI-generated art is not real art", cat: "Technology" },
  { text: "Automation will create more jobs than it destroys", cat: "Technology" },
  ...
  { text: "Self-driving cars will save more lives than they risk", cat: "Technology" },
  ...
  { text: "Nuclear power is the only viable path to net zero", cat: "Environment" },
  ...
  { text: "Flying should be heavily taxed to reduce emissions", cat: "Environment" },
  ...
  { text: "We have already passed the point of no return on climate", cat: "Environment" },
  ...
  { text: "Economic growth is incompatible with sustainability", cat: "Economics" },
  { text: "Privatization of public services always fails", cat: "Economics" },
  { text: "A wealth tax is fair and feasible", cat: "Economics" },
  { text: "Globalization has made the world worse for most people", cat: "Economics" },
  ...
  { text: "The stock market does not reflect the real economy", cat: "Economics" },
  ...
  { text: "Traditional universities are becoming obsolete", cat: "Education" },
  { text: "Grades are a poor measure of intelligence", cat: "Education" },
  { text: "Philosophy should be taught from primary school", cat: "Education" },
  ...
  { text: "The war on drugs has failed", cat: "Health" },
  ...
  { text: "Sleep is more important than diet and exercise combined", cat: "Health" },
  { text: "Burnout is caused by employers not employees", cat: "Health" },
  { text: "Addiction is a disease not a moral failing", cat: "Health" },
  { text: "Jury trials are outdated and should be replaced", cat: "Law" },
  ...
  { text: "The British Empire should issue formal apologies and reparations", cat: "History" },
  { text: "The United Nations has been a failure", cat: "History" },
  { text: "The printing press was more transformative than the internet", cat: "History" },
  ...
  { text: "MMA is more of a sport than boxing", cat: "Sports" },
  ...
  { text: "Fan culture has become too toxic", cat: "Sports" },
  ...
  { text: "Age gaps in relationships are inherently problematic", cat: "Relationships" },
  ...
  { text: "Online dating is superior to meeting in person", cat: "Relationships" },
  { text: "A plant-based diet is the only ethical choice", cat: "Food" },
  { text: "Food culture has become insufferably pretentious", cat: "Food" },
  { text: "Lab-grown meat will replace traditional meat within 20 years", cat: "Food" },
  { text: "Insects are the food of the future and we should embrace it", cat: "Food" },
  ...
  { text: "Globalization has failed ordinary workers everywhere", cat: "International" },
  { text: "Open borders would solve more problems than they create", cat: "International" },
  { text: "The era of American global dominance is over", cat: "International" },
  { text: "International aid creates dependency not development", cat: "International" },
  { text: "Pineapple belongs on pizza", cat: "Hot Take" },
  { text: "Cats are better than dogs", cat: "Hot Take" },
  { text: "Coffee is overrated", cat: "Hot Take" },
  { text: "Breakfast is the most important meal of the day", cat: "Hot Take" },
  ...
  { text: "Being popular in high school is a disadvantage in life", cat: "Hot Take" },
  ...
  { text: "Horror movies are better than rom-coms", cat: "Hot Take" },
];
