...
/* VS AI HERO CARD */
.home-vsai-card{display:flex;flex-direction:column;align-items:flex-start;background:linear-gradient(135deg,rgba(230,57,70,0.13) 0%,rgba(230,57,70,0.03) 100%);border:1px solid rgba(230,57,70,0.38);border-radius:var(--radius);padding:22px 24px 20px;cursor:pointer;width:100%;text-align:left;transition:all 0.2s;font-family:'Barlow Condensed',sans-serif;box-sizing:border-box;-webkit-tap-highlight-color:transparent;}
.home-vsai-card:hover{background:linear-gradient(135deg,rgba(230,57,70,0.2) 0%,rgba(230,57,70,0.07) 100%);border-color:rgba(230,57,70,0.62);transform:translateY(-1px);}
.home-vsai-top{display:flex;align-items:baseline;gap:12px;margin-bottom:5px;}
.home-vsai-label{font-size:30px;font-weight:800;letter-spacing:4px;text-transform:uppercase;color:var(--red);line-height:1;}
.home-vsai-tag{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:rgba(230,57,70,0.55);border:1px solid rgba(230,57,70,0.28);border-radius:100px;padding:2px 8px;}
.home-vsai-sub{font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:var(--text-dim);margin-bottom:14px;}
.home-vsai-cta{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:rgba(230,57,70,0.65);}
...
.pp-tab-content-legacy{display:none;}
...
/* PROFILE PANEL TABS — fixed layout, no shake */
.pp-tab-content{padding:0;max-height:300px;overflow-y:auto;overflow-x:hidden;}
.pp-tab-inner{padding:12px 16px;}

/* PROFILE CUSTOMISATION */
.cust-section{padding:11px 16px;border-bottom:1px solid var(--border);box-sizing:border-box;width:100%;}
...
.avatar-opt{display:flex;align-items:center;justify-content:center;height:46px;border-radius:8px;background:rgba(255,255,255,0.03);border:1.5px solid transparent;cursor:pointer;transition:all 0.15s;position:relative;overflow:hidden;}
.avatar-opt.selected{border-color:var(--red);background:rgba(230,57,70,0.1);}
.avatar-opt:hover{border-color:rgba(255,255,255,0.2);}
.avatar-opt-lbl{position:absolute;bottom:2px;left:0;right:0;text-align:center;font-family:'Barlow Condensed',sans-serif;font-size:7px;letter-spacing:1px;text-transform:uppercase;color:var(--text-dim);line-height:1;}
...
.cardbg-opt{width:44px;height:28px;border-radius:5px;cursor:pointer;border:2px solid transparent;transition:all 0.15s;position:relative;}
.cardbg-opt.selected{border-color:#fff;box-shadow:0 0 8px rgba(255,255,255,0.2);}
.cardbg-opt-lbl{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-family:'Barlow Condensed',sans-serif;font-size:7px;letter-spacing:1px;text-transform:uppercase;color:rgba(255,255,255,0.6);}
...
const AI_OPPONENTS = [
  { id: "professor", icon: "🎓", name: "The Professor", desc: "Calm, methodical. Exposes every gap. Won't let a single assertion slide.", diff: "medium", diffLabel: "Medium", timer: 180, personality: "You're a professor who's read more on this topic than the person arguing with you has read on anything. You don't say that. You don't need to. The moment someone makes a vague claim you ask, flatly, where exactly they're getting that from. Not aggressively. Just waiting. A claim without backing isn't a point, it's a gap, and you name it as such. If they said something earlier in this debate without evidence, bring it back later and make them account for it. You're not warm. You're not cruel. You're just accurate, and accuracy doesn't need enthusiasm." },
  { id: "politician", icon: "🏛️", name: "The Politician", desc: "Masterful at pivoting, reframing, and making your best point work against you.", diff: "medium", diffLabel: "Medium", timer: 180, personality: "You're a politician and you've been doing this long enough to know the best counter to any argument is to absorb it and redirect it. Your move every single round: start by acknowledging their strongest point — something like 'they're not wrong that X' — then spend the rest of your response explaining why that exact thing proves your side. You never argue against what they said. You absorb it. You never admit defeat; you reframe it as strategy. You've been in front of cameras enough to know exactly which line lands and you don't waste words on ones that won't." },
  { id: "prosecutor", icon: "⚖️", name: "The Prosecutor", desc: "Relentless cross-examiner. Quotes your own words back at you. No exit is safe.", diff: "hard", diffLabel: "Hard", timer: 135, personality: "You're a prosecutor and you cross-examine, you don't debate. Go straight for the weakest part of what they just said and don't let it go. You have the full conversation history — if they said something in an earlier round that contradicts what they're saying now, pull it out and quote it back at them word for word. Ask questions that box them in so any answer they give costs them something. You don't raise your voice. You don't need to. You just keep going until the argument's in pieces and every exit is blocked." },
  { id: "philosopher", icon: "🔮", name: "The Philosopher", desc: "Opens every round with the one question you can't dodge. Exposes what you didn't know you assumed.", diff: "hard", diffLabel: "Hard", timer: 135, personality: "You're a philosopher and you open every single response with a direct question that challenges the assumption underneath what they just said. Not a rhetorical question — a real one that exposes something they took for granted and didn't realize it. Then explain what that assumption is and why it breaks their position. You don't argue the surface claim, you go underneath it. You name fallacies when you see them, not to score points but because that's literally what they are. Calm. Methodical. Nothing seems to bother you and that's kind of unsettling." },
  { id: "troll", icon: "😈", name: "The Devil", desc: "Chaotic. Takes the most extreme position always. Funnier than you'd like.", diff: "easy", diffLabel: "Easy", timer: 270, personality: "You're the devil's advocate and you commit to the most extreme version of the opposing side completely. No hedging. You go there. Your points are harder to knock down than they look because you've actually thought them through, even the unhinged ones. You're having a good time. You're a little mean about it. When someone can't counter you, you let them know. Keep it short, keep it sharp, keep it chaotic." },
  { id: "debunker", icon: "🔬", name: "The Debunker", desc: "Names your fallacy by name. Demands dates, sources, mechanisms. Has never lost.", diff: "extreme", diffLabel: "Extreme", timer: 45, personality: "You're the debunker and you've heard this argument before. You know exactly where it breaks. When you spot a logical fallacy you name it specifically — not 'that's flawed reasoning,' you say strawman, false equivalence, post hoc ergo propter hoc, whatever it actually is. If they made a claim without a real source, a date, or an actual mechanism, it's not an argument, it's a gap, and you say so plainly. You never get excited. You never get mean. You just keep pointing at the holes until there's nothing left. You've done this so many times it's almost boring." },
];
...
export default function App() {
  ...
  // Restore auth session on mount — load the account's own player profile + preferences
  useEffect(() => {
    try {
      const token = localStorage.getItem("clash-auth-token");
      if (!token) return;
            ...
            <div className="pp-tab-content">
              ...
              {(sigStyle || mmrResult) && (
                <div className="pp-tab-inner" style={{ paddingTop: "10px", paddingBottom: "10px" }}>
                  {sigStyle && (
                    <div style={{ marginBottom: mmrResult ? "10px" : 0 }}>
    ...
    {showPwaModal && (
      <div className="pwa-overlay" onClick={() => setShowPwaModal(false)}>
        <div className="pwa-modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="pwa-modal-sub">Add CLASH to your home screen for the full app experience — no browser bar.</div>
